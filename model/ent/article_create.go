...
func (ac *ArticleCreate) SetImage(s string) *ArticleCreate {
	ac.mutation.SetImage(s)
	return ac
}

// SetNillableImage sets the "image" field if the given value is not nil.
func (ac *ArticleCreate) SetNillableImage(s *string) *ArticleCreate {
	if s != nil {
		ac.SetImage(*s)
	}
	return ac
...
func (ac *ArticleCreate) SetViews(i int64) *ArticleCreate {
	ac.mutation.SetViews(i)
	return ac
}

// SetNillableViews sets the "views" field if the given value is not nil.
func (ac *ArticleCreate) SetNillableViews(i *int64) *ArticleCreate {
	if i != nil {
		ac.SetViews(*i)
	}
	return ac
...
func (ac *ArticleCreate) check() error {
	...
	if v, ok := ac.mutation.ContentHTML(); ok {
